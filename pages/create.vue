<template>
  <main class="mx-auto max-w-screen-md px-4 py-10">
    <!-- Create Form -->
    <form
      class="flex h-fit flex-col gap-4 rounded-md bg-white p-8 shadow-lg transition-all"
    ...
    >
      ...
      <section class="mb-2 flex flex-col">
        ...
        >
          <option value="" disabled selected hidden>Select Workout Type</option>
          ...
          >
            <section class="flex flex-col md:w-1/3">
              ...
              <select
                ...
                class="w-full rounded-md border border-gray-500 p-2 text-purple-500 focus:outline-none"
              >
